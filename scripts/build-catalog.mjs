...
fs.writeFileSync(path.join(out, 'search-index.json'), JSON.stringify(catalog.map(({ id, language, package: pkg, type, method, role, kind, slug }) => ({ id, language, package: pkg, type, method, role, kind, slug }))));
