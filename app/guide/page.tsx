...
export const metadata = { title: 'Field guide — Atropos Observatory', description: 'A concise guide to Atropos roles, model facts, provenance, and editorial guidance.', alternates: { canonical: '/guide' } };
