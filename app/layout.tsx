...
const structuredData = { '@context': 'https://schema.org', '@type': 'WebSite', name: 'Atropos Observatory', url: 'https://atropos.unboundcompute.com', description: 'Searchable security semantics index for the Atropos model pack.', potentialAction: { '@type': 'SearchAction', target: 'https://atropos.unboundcompute.com/browse?q={search_term_string}', 'query-input': 'required name=search_term_string' } };
