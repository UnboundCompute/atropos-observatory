...
export default function Layout({ children }: Readonly<{ children: React.ReactNode }>) {
  return <html lang="en"><body className={`${plexSans.variable} ${plexMono.variable} ${sourceSerif.variable}`}><header className="site-header"><Link href="/" className="wordmark"><span className="monogram">AO</span><span><strong>Atropos</strong><small>Observatory</small></span></Link><nav aria-label="Primary navigation"><Link href="/browse">Index</Link><Link href="/guide">Field guide</Link><a href="https://trace.unboundcompute.com/">Casefiles</a><a href="https://github.com/UnboundCompute/atropos">Source</a></nav></header>{children}<footer><span>Atropos Core Models · CC-BY-4.0</span><span>UnboundCompute / Security semantics for static analysis</span></footer></body></html>;
}
