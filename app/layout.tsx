...
export const metadata: Metadata = { metadataBase: new URL(siteUrl), title: 'Atropos Observatory — Security Semantics Index', description: 'Search exact source, sink, sanitizer, and summary facts from the Atropos model pack.' };
