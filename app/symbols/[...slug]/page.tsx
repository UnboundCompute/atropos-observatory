...
export default async function SymbolPage({ params }: { params: Promise<{ slug: string[] }> }) {
  ...
  const traceLinks = casefiles.length ? casefiles.map((url) => <a href={url} key={url}>Open related Trace Casefile ↗</a>) : <a href="https://trace.unboundcompute.com/">Open Trace Casefiles ↗</a>;
