...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [{ url: base, changeFrequency: 'weekly', priority: 1 }, { url: `${base}/browse`, changeFrequency: 'weekly', priority: 0.8 }, { url: `${base}/guide`, changeFrequency: 'monthly', priority: 0.7 }, { url: `${base}/coverage`, changeFrequency: 'weekly', priority: 0.6 }, ...roles, ...languages, ...kinds, ...cwes, ...symbols];
}
